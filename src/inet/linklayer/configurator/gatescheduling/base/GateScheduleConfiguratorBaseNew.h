...
#ifndef __INET_GATESCHEDULECONFIGURATORBASENEW_H
#define __INET_GATESCHEDULECONFIGURATORBASENEW_H
...
class INET_API GateScheduleConfiguratorBaseNew : public NetworkConfiguratorBase
{
  protected:
  ...
  public:
    virtual ~GateScheduleConfiguratorBaseNew() { clearConfiguration(); }
};
